...
import { aboutupload, galleryupload, logoupload, menuupload, ourteamupload, serviceupload, sliderupload, testimonialupload, whychooseusupload } from "../multerStorage/multer-config.js";
...
import ourteamController from "../controllers/ourteamController.js";
...
// OUR TEAM API
Router.post("/addourteam", ourteamupload.single("image"), ourteamController.addnewteam)
