...
const Settings = () => {
  const getsitesetting = async () => {
    ...
    if (res.status == 200) {
      setHasData(true);
      setData({
        businessname: res?.data?.data[0]?.businessname,
        phonenumber: res?.data?.data[0]?.phonenumber,
        email: res?.data?.data[0]?.email,
        fblink: res?.data?.data[0]?.fblink,
        twitterlink: res?.data?.data[0]?.twitterlink,
        linkedlink: res?.data?.data[0]?.linkedlink,
        youtubelink: res?.data?.data[0]?.youtubelink,
        shortdescriptionaboutbusiness:
          res?.data?.data[0]?.shortdescriptionaboutbusiness,
        businesslogo: res?.data?.data[0]?.businesslogo,
      });
    }
  };
              ...
              <div className="p-7">
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-5.5">
                    ...
                    <input
                      className="w-full mt-4 rounded border border-stroke bg-gray py-3 px-4.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                      type="text"
                      name="twitterlink"
                      id="Username"
